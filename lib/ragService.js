            ...
            messages: [
              {
                ...
                content:
                  ...
                  'For measurement questions, treat values as type/value/unit/rpm/temp and compare directly only when unit+conditions are compatible (especially cps with same rpm unless explicit normalization is stated). If compatibility is missing, say direct comparison is not valid from context. ' +
                  'Classify evidence text as formulation / experiment_result / qc_data and prioritize experiment_result/qc_data for measured outcomes such as viscosity/pH; if classification is ambiguous, state uncertainty and avoid guessing. ' +
